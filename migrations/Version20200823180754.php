 ...
 */
final class Version20200823180754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE distance (id INT AUTO_INCREMENT NOT NULL, station_a VARCHAR(255) NOT NULL, station_b VARCHAR(255) NOT NULL, distance DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
